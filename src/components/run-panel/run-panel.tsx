...
const RunPanel = observer(() => {
    ...
    const { BOT_BUILDER, CHART, ANALYSIS_TOOL, TRADING_VIEW } = DBOT_TABS;
    ...
    const show_run_panel = [BOT_BUILDER, CHART, ANALYSIS_TOOL, TRADING_VIEW].includes(active_tab) || active_tour;
